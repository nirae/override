...
void set_username(struct s_message *message) {
    ...
    0x00000000000009d1 <+4>:	sub    rsp,0xa0
        total stack = 160
    0x00000000000009d8 <+11>:	mov    QWORD PTR [rbp-0x98],rdi     ; arg
    ...
    */
    ...
    0x00000000000009ee <+33>:	mov    edx,0x10     16
    0x00000000000009f3 <+38>:	mov    rdi,rsi
    0x00000000000009f6 <+41>:	mov    rcx,rdx
    0x00000000000009f9 <+44>:	rep stos QWORD PTR es:[rdi],rax     ; bzero
    */
    bzero(buffer, 1128);
    /*
    ...
    */
    while (i <= 40 && buffer[i] != 0) {
        ...
        0x0000000000000a4b <+126>:	movzx  ecx,BYTE PTR [rbp+rax*1-0x90]    buffer[i]
        0x0000000000000a53 <+134>:	mov    rdx,QWORD PTR [rbp-0x98]         message
        0x0000000000000a5a <+141>:	mov    eax,DWORD PTR [rbp-0x4]
        0x0000000000000a5d <+144>:	cdqe   
        0x0000000000000a5f <+146>:	mov    BYTE PTR [rdx+rax*1+0x8c],cl     message->username[i] = buffer[i]
        */
    ...
    0x0000000000000a88 <+187>:	lea    rdx,[rax+0x8c]              message+140 = message->username
...
void set_msg(struct s_message *message) {
    ...
    0x0000000000000936 <+4>:	sub    rsp,0x410
        total stack = 1040
    0x000000000000093d <+11>:	mov    QWORD PTR [rbp-0x408],rdi ; arg
    0x0000000000000944 <+18>:	lea    rax,[rbp-0x400]
        rbp-0x400 = 1024 ;  char[1024]
    */
    ...
    0x000000000000095e <+44>:	rep stos QWORD PTR es:[rdi],rax             ; bzero
    */
    bzero(buffer, 128 * 8);
    /*
    ...
    */
    ...
    0x00000000000009b9 <+135>:	mov    rax,QWORD PTR [rbp-0x408]    arg
...
void handle_msg(void) {
    ...
    */
    ...
    0x00000000000008df <+31>:	mov    QWORD PTR [rax+0x8],0x0      8
    0x00000000000008e7 <+39>:	mov    QWORD PTR [rax+0x10],0x0     16
    0x00000000000008ef <+47>:	mov    QWORD PTR [rax+0x18],0x0     24
    0x00000000000008f7 <+55>:	mov    QWORD PTR [rax+0x20],0x0     32
        QWORD = +8 ; 32 + 8 = 40
        equivalent to bzero 40
        char[40]
    */
