...
int main(void) {
    ...
    */
    ...
    0x080484f3 <+175>:	repnz scas al,BYTE PTR es:[edi]  strlen on buffer
    ...
    */
    while (i < strlen(buffer)) {
        ...
        0x0804848b <+71>:	add    eax,DWORD PTR [esp+0x8c]     buffer[i]
        ...
        */
        if (buffer[i] > 64) {
            ...
            0x0804849d <+89>:	add    eax,DWORD PTR [esp+0x8c]     buffer[i]
            ...
            */
            if (buffer[i] < 90) {
                ...
                0x080484af <+107>:	add    eax,DWORD PTR [esp+0x8c]     buffer[i]
                0x080484b6 <+114>:	movzx  eax,BYTE PTR [eax]
                0x080484b9 <+117>:	mov    edx,eax
                0x080484bb <+119>:	xor    edx,0x20                     buffer[i] ^ 32
                0x080484be <+122>:	lea    eax,[esp+0x28]
                0x080484c2 <+126>:	add    eax,DWORD PTR [esp+0x8c]     buffer[i]
