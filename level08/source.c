void log_wrapper(FILE *file, char *info, char *name) {
    ...
    0x00000000004008c8 <+4>:	sub    rsp,0x130
        total stack = 304
    0x00000000004008cf <+11>:	mov    QWORD PTR [rbp-0x118],rdi    file
    0x00000000004008d6 <+18>:	mov    QWORD PTR [rbp-0x120],rsi    info
    0x00000000004008dd <+25>:	mov    QWORD PTR [rbp-0x128],rdx    name
    ...
    */
    ...
    0x0000000000400937 <+115>:	repnz scas al,BYTE PTR es:[rdi]                   strlen buffer
    ...
    0x0000000000400948 <+132>:	mov    r8,rax           254
    0x000000000040094b <+135>:	sub    r8,rdx           254 - len buffer
    ...
    0x0000000000400972 <+174>:	repnz scas al,BYTE PTR es:[rdi]                 strlen buffer
    ...
    */
    ...
    0x00000000004009de <+282>:	xor    rax,QWORD PTR fs:0x28                canary?
...
int main(int ac, char **av) {
    ...
    */
    ...
    0x0000000000400a98 <+168>:	add    rax,0x8                      argv[1]
    0x0000000000400a9c <+172>:	mov    rdx,QWORD PTR [rax]
    0x0000000000400a9f <+175>:	mov    rax,QWORD PTR [rbp-0x88]     log_file
    ...
    */
    FILE *arg_file = fopen(av[1], "r"); /* rbp-0x80 */
    /*
    ...
    */
    ...
    0x0000000000400b48 <+344>:	repnz scas al,BYTE PTR es:[rdi]                     strcpy "./backups/" dans rbp-0x70
    */
    char buffer[100]; /* rbp-0x70 */
    strcpy(buffer);
    /*
    0x0000000000400b4a <+346>:	mov    rax,rcx              len from strcpy
    0x0000000000400b4d <+349>:	not    rax
    0x0000000000400b50 <+352>:	lea    rdx,[rax-0x1]        len - 1
    0x0000000000400b54 <+356>:	mov    eax,0x63
    0x0000000000400b59 <+361>:	mov    rcx,rax
    0x0000000000400b5c <+364>:	sub    rcx,rdx              99 - (len - 1)
    ...
    */
    ...
    0x0000000000400c0c <+540>:	add    rax,0x8                      argv[1]
